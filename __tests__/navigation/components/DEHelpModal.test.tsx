...
describe('DEHelpModal Component', () => {
  ...
  it('renders the single elimination help content when format is single', () => {
    ...
    expect(getByText(/The bracket is structured to delay matches between top seeds until later rounds./)).toBeTruthy();
  ...
  it('renders the double elimination help content when format is double', () => {
    ...
    expect(getByText(/• If the Losers Bracket winner defeats the Winners Bracket winner, a "bracket reset"/)).toBeTruthy();
  });
