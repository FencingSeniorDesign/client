...
export class AuthenticationError extends NetworkError {
    constructor(message: string, isRecoverable = false, originalError?: any) {
...
export class TimeoutError extends NetworkError {
    constructor(message: string, code: NetworkErrorCode = NetworkErrorCode.MESSAGE_TIMEOUT, isRecoverable = true) {
