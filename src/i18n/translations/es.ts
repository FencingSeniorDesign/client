export default {
    ...
    ble: {
        ...
        dataSourceDescription: 'Elija si la aplicación o la caja controla los datos',
        useAppData: 'Usar datos de la aplicación',
        appDataDescription: 'La aplicación controla puntuaciones y temporizador, la caja sigue',
        useBoxData: 'Usar datos de la caja',
        boxDataDescription: 'La caja controla puntuaciones y temporizador, la aplicación sigue',
        appDataSource: 'Control de aplicación',
        boxDataSource: 'Control de caja',
