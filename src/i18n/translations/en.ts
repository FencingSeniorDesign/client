export default {
    ...
    ble: {
        ...
        dataSourceDescription: 'Choose whether the app or box controls the data',
        useAppData: 'Use App Data',
        appDataDescription: 'App controls scores and timer, box follows',
        useBoxData: 'Use Box Data',
        boxDataDescription: 'Box controls scores and timer, app follows',
        appDataSource: 'App Control',
