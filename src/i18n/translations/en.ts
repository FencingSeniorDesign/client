export default {
    ...
    ncaaTeamBout: {
        ...
        failedToAssignRandomScores: 'Failed to assign random scores',
        randomScoresAssigned: 'Random scores assigned to all bouts',
        assignRandomScoresToAllBouts: 'Assign Random Scores to All Bouts',
        vs: 'vs',
        teamA: 'Team A',
        teamB: 'Team B',
    },
    relayTeamBout: {
        ...
        errorLoadingBoutStatus: 'Error loading relay bout status',
        errorWithSubstitution: 'Error with substitution',
        scoresCannotBeNegative: 'Scores cannot be negative',
        teamScoreExceedsLimit: 'Team {{team}} score cannot exceed {{limit}} for leg {{leg}}. Maximum additional score: {{max}}',
        errorUpdatingLegScore: 'Error updating leg score',
        invalidLegScore: 'Invalid leg score. Maximum 5 combined touches per leg.',
        errorSavingScores: 'Error saving scores from referee module',
        selectedLegNotFound: 'Selected leg not found',
        errorSavingLegScore: 'Error saving leg score from referee module',
        errorLoadingBoutData: 'Error loading bout data',
        retry: 'Retry',
        vs: 'VS',
        winner: 'WINNER',
        enterFencerScores: 'Enter Fencer Scores',
        manualInput: 'Manual Input',
        refereeModule: 'Referee Module',
        currentLeg: 'Current Leg',
        legControl: 'Leg Control',
        legHistory: 'Leg History',
        viewRosters: 'View Rosters',
        boutManagement: 'Bout Management',
        sub: 'Sub {{team}}',
        boutComplete: 'Bout Complete',
        finalScore: 'Final Score: {{scoreA}} - {{scoreB}}',
        enterLegScore: 'Enter Leg Score',
        legNumberDescription: 'Leg {{number}} - Individual fencer scores',
        currentLegDescription: 'Current Leg - Individual fencer scores',
        ...
        complete: 'Complete',
        inProgress: 'In Progress',
        currentLegStatus: 'Current leg',
        tapForEditOptions: 'Tap for edit options',
        tapToEdit: 'Tap to edit',
        editLeg: 'Edit Leg',
        editLegPrompt: 'How would you like to edit Leg {{number}}?',
        manualEntry: 'Manual Entry',
        enterScoresForThisLeg: 'Enter scores for this leg:',
        submit: 'Submit',
    ...
    teamDEBracketPage: {
        ...
        noBoutsFound: 'No bouts found in bracket',
        finals: 'Finals',
    ...
    teamBoutOrderPage: {
        ...
        confirmCompleteMessage: 'Are you sure you want to mark this pool as complete?',
        errorCompletingPool: 'Failed to complete pool',
        ncaaFormat: 'NCAA (9 bouts)',
        relayFormat: '45-touch Relay',
    },
    assignRandomScoresToAllBouts: 'Assign Random Scores to All Bouts',
    teamLegScoreValidation: {
        scoreCannotBeNegative: 'Scores cannot be negative',
        teamScoreExceedsLimit: 'Team {{team}} score cannot exceed {{limit}} for leg {{leg}}. Maximum additional score: {{max}}',
    },
};
