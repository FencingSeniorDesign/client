...
export const AbilityProvider: React.FC<AbilityProviderProps> = ({ children }) => {
    ...
    const refreshAbility = async (tournamentName?: string) => {
        ...
        console.log(
            'Created new ability with permissions:',
            'Can manage all?',
            newAbility.can('manage', 'all'),
            'Can manage Tournament?',
            newAbility.can('manage', 'Tournament')
        );
    ...
    useEffect(() => {
        const handleRoleAssigned = ({
            ...
            console.log(
                `AbilityProvider: Received roleAssigned event: role=${roleString}, tournament=${tournamentName}`
            );
            ...
            console.log(
                'AbilityProvider: Updating ability based on server assigned role:',
                'Can manage all?',
                newAbility.can('manage', 'all'),
                'Can score Bout?',
                newAbility.can('score', 'Bout')
            );
