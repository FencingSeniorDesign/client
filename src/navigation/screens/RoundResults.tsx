...
const RoundResults: React.FC = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {viewMode === 'list' && poolResults.map(poolResult => (
        <PoolListView key={poolResult.poolid} poolResult={poolResult} />
      ))}
      
      {viewMode === 'poolSheet' && poolResults.map(poolResult => (
        <PoolSheetView key={poolResult.poolid} poolResult={poolResult} />
      ))}
