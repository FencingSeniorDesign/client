...
const BoutOrderPage: React.FC = () => {
    ...
    const { poolFencers, updatedBout } = route.params;
    ...
    /**
     * Handle updated bout scores if provided
     */
    useEffect(() => {
        if (updatedBout) {
            setBouts((prev) => {
                const newBouts = [...prev];
                newBouts[updatedBout.boutIndex].scoreA = updatedBout.score1;
                newBouts[updatedBout.boutIndex].scoreB = updatedBout.score2;
                newBouts[updatedBout.boutIndex].status = 'completed';
                const concurrency = doubleStrip ? 2 : 1;
                        ...
                        <View key={index} style={{ marginBottom: 12 }}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {bout.fencerA.id ? fencerIndexMap[bout.fencerA.id] : ''} {bout.fencerA.fname}
                                    </Text>
                                </View>
                                ...
                                >
                                    ...
                                    >
                                        {bout.fencerB.id ? fencerIndexMap[bout.fencerB.id] : ''} {bout.fencerB.fname}
                                    </Text>
                                </View>
                            </TouchableOpacity>
                                ...
                                <View style={styles.scoreEntryContainer}>
                                    ...
                                    <View style={styles.scoreRow}>
                                        <Text style={styles.scoreFencerLabel}>
                                            {bout.fencerA.id ? fencerIndexMap[bout.fencerA.id] : ''}{' '}
                                            {bout.fencerA.fname}:
                                        </Text>
                                        <TextInput
                                    ...
                                    <View style={styles.scoreRow}>
                                        <Text style={styles.scoreFencerLabel}>
                                            {bout.fencerB.id ? fencerIndexMap[bout.fencerB.id] : ''}{' '}
                                            {bout.fencerB.fname}:
                                        </Text>
                                        <TextInput
                                            style={styles.scoreInput}
