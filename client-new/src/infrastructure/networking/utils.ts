// src/infrastructure/networking/utils.ts - Network utility functions
...
export async function getClientConnectionInfo(): Promise<{
    ...
    // We'll need to set isRemote later after importing client
    const isRemote = false; // Will be set correctly when used
