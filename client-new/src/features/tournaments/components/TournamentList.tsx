...
import { useTournamentRepository } from '../hooks/useTournamentRepository';
...
export const TournamentList: React.FC<TournamentListProps> = ({
    ...
    const handleTournamentPress = (tournamentName: string) => {
        // Navigate to tournament details or event management
        // @ts-ignore - will be fixed when we integrate with navigation properly
        ...
        Alert.alert(
            ...
            [
                ...
                },
                {
                    ...
                    onPress: async () => {
                        try {
                            // Use the repository to delete the tournament
                            await tournamentRepository.delete(tournamentName);
                            if (onTournamentDeleted) {
                                onTournamentDeleted(); // Refresh the tournament list if callback provided
                            }
                        } catch (error) {
