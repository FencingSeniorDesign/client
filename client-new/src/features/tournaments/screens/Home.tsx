...
import CreateTournamentButton from '../components/CreateTournamentModal';
import TournamentListContainer from '../components/TournamentListContainer';
import JoinTournamentModal from '../components/JoinTournamentModal';
import tournamentClient from '../../../infrastructure/networking/client';
import { MainStackNavigationProp } from '../../../navigation/types';

// Import the logo image
// Note: We still need to update asset paths after migration
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.ongoingTournamentsContainer}>
          <TournamentListContainer isComplete={false} />
        </View>

        {/* Tournament History Section */}
        <Text style={styles.tournamentHistoryTitle}>Tournament History</Text>
        <View style={styles.historyContainer}>
          <TournamentListContainer isComplete={true} />
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  connectedContainer: {
    ...
    alignItems: 'center',
    width: '100%',
    height: 70, // Increased for showing disconnect button too
    borderWidth: 1,
    borderColor: '#b3e5fc',
  },
  connectedText: {
